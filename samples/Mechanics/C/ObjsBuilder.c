...
Sprite* g_objects[] = {
    &PhxSprite_Ctor(                                            /* right_wall */
        P( { 0.7188414700064787, 0.466297238372093, 0.02032661852133018, 0.2870639534883721 } )/* m_iniRect */,
        P( "right_wall" )                                       /* m_name */,
    ...
    &PhxSprite_Ctor(                                            /* left_wall */
        P( { 0.03712871287128713, 0.12908793604651161, 0.019801980198019802, 0.5603197674418605 } )/* m_iniRect */,
        P( "left_wall" )                                        /* m_name */,
        P( "GreenLight.png" )                                   /* m_imgPath */,
        P( (cpVect[]){ {-0.48502126850387656, -0.4850207048733655}, {-0.48502126850387656, 0.48502066617728246}, {0.4850196348219552, 0.48502066617728246}, {0.4850196348219552, -0.4850207048733655} } )/* m_verts */,
        P( 4 )                                                  /* m_vertsCnt */,
    ...
    &PhxSprite_Ctor(                                            /* floor */
        P( { 0.04111869772925099, 0.6923146802325582, 0.6752475247524753, 0.06395348837209303 } )/* m_iniRect */,
        P( "floor" )                                            /* m_name */,
        P( "GreenLight.png" )                                   /* m_imgPath */,
        P( (cpVect[]){ {-0.48502126850387656, -0.4850207048733655}, {-0.48502126850387656, 0.48502066617728246}, {0.4850196348219552, 0.48502066617728246}, {0.4850196348219552, -0.4850207048733655} } )/* m_verts */,
        P( 4 )                                                  /* m_vertsCnt */,
    ...
    &PhxSprite_Ctor(                                            /* arm_main */
        P( { 0.18831341720119826, 0.4511113129844962, 0.0784653465346535, 0.14874213423461297 } )/* m_iniRect */,
        P( "arm_main" )                                         /* m_name */,
        ...
        P( 1 )                                                  /* m_mass */,
        P( 3 )                                                  /* m_group */,
        P( &PhxGrooveJoint_Ctor( &arm_main_hanger, 1, &arm_pivot_position, &arm_main_hanger, null, &PhxRotaryLimitJoint_Ctor( &arm_main_hanger, 1, -15.0, 15.0, null ) ) )/* m_joints */,
        P( false )                                              /* m_isStaticBody */
    ),
    &PhxSprite_Ctor(                                            /* arm_right */
        P( { 0.23394047990746886, 0.551735101744186, 0.05148514851485148, 0.1068313953488372 } )/* m_iniRect */,
        P( "arm_right" )                                        /* m_name */,
    ...
    &PhxSprite_Ctor(                                            /* arm_left */
        P( { 0.170079093768855, 0.5486299220401692, 0.05148514851485148, 0.1099365750528541 } )/* m_iniRect */,
        P( "arm_left" )                                         /* m_name */,
    ...
    &FlexButton_Ctor(                                           /* leftButton */
        P( { 0.7747613762102172, 0.7134573124307863, 0.02032661852133018, 0.029094046486147603 } )/* m_iniRect */,
        P( "leftButton" )                                       /* m_name */,
    ...
    &PhxSprite_Ctor(                                            /* prize0 */
        P( { 0.4055088149833578, 0.44918408028488765, 0.08382816470263565, 0.1776320397870553 } )/* m_iniRect */,
        P( "prize0" )                                           /* m_name */,
    ...
821}, {0.2649530669057801, 0.28388631896988303}, {0.2743274916590513, 0.1048836825332797}, {0.4125986511935142, 0.15858452920696256}, {0.4969676711848114, 0.15207526810384725}, {0.5063415607459867, 0.09511997668761289}, {0.29776355354222944, -0.0920188645098723}, {0.40088062025192517, -0.2108113931696775}, {0.31885574164104175, -0.4028321801944992}, {0.3868192507180663, -0.4500237657650667}, {0.365727062619254, -0.5313884146999712}, {0.22745617068083906, -0.5623070333217566} } )/* m_verts */,
        P( 30 )                                                 /* m_vertsCnt */,
    ...
    &PhxSprite_Ctor(                                            /* arm_main_hanger */
        P( { 0.21785137099657778, 0.09751998546511625, 0.019801980198019802, 0.029069767441860465 } )/* m_iniRect */,
    ...
    &ImgSprite_Ctor(                                            /* gate_position */
        P( { 0.8064652323827164, 0.0970657703488372, 0.019801980198019802, 0.029069767441860465 } )/* m_iniRect */,
    ...
    &ClawMachine_Ctor(                                          /* clawMachine */
        P( { 0.805970182877766, 0.306140988372093, 0.14356435643564355, 0.25336119186046513 } )/* m_iniRect */,
    ...
    &FlexButton_Ctor(                                           /* rightButton */
        P( { 0.8458068736171006, 0.7135870881782946, 0.02032661852133018, 0.029094046486147603 } )/* m_iniRect */,
    ...
    &ImgSprite_Ctor(                                            /* home_position */
        P( { 0.10894047990746882, 0.0970657703488372, 0.019801980198019802, 0.029069767441860465 } )/* m_iniRect */,
    ...
    &FlexButton_Ctor(                                           /* clawButton */
        P( { 0.9165989528250216, 0.7133448401162791, 0.02032661852133018, 0.029094046486147603 } )/* m_iniRect */,
        P( "clawButton" )                                       /* m_name */,
        P( "FlexButton.png" )                                   /* m_imgPath */,
        P( 1 )                                                  /* m_valueMax */,
        P( FlexBtnStm_PushStyle )                               /* m_style */,
    ...
    &PhxSprite_Ctor(                                            /* prize3 */
        P( { 0.35266996191258665, 0.25694949127906974, 0.08382816470263565, 0.1776320397870553 } )/* m_iniRect */,
        P( "prize3" )                                           /* m_name */,
        P( "crane_game_prize.png" )                             /* m_imgPath */,
        P( (cpVect[]){ {0.14308688309349385, -0.5102329444968342}, {-0.04205559741918127, -0.5232512808940586}, {-0.19907533886413867, -0.50209636811794}, {-0.28110048507107005, -0.5525425842400652}, {-0.4076536136639439, -0.5167420197909434}, {-0.43108914035502605, -0.4223590344588144}, {-0.3631253636819535, -0.38004939471558336}, {-0.42874553416670824, -0.21894722631254707}, {-0.3021921379777864, -0.07411802485829294}, {-0.4849912798981917, 0.11464813161497109}, {-0.46858630417601504, 0.17485823939176925}, {-0.37718700081186035, 0.18136694306786613}, {-0.27406939891006865, 0.11139368687241957}, {-0.2459463922463029, 0.3082962339155716}, {-0.17095206460432494, 0.4319705225937071}, {-0.07252167507916885, 0.4254608898725795}, {0.014190951100446188, 0.26273140619376445}, {0.15011796925449528, 0.41081523819957627}, {0.24151754021469793, 0.4026786618206821}, {0.2649530669057801, 0.28388631896988303}, {0.2743274916590513, 0.1048836825332797}, {0.4125986511935142, 0.15858452920696256}, {0.4969676711848114, 0.15207526810384725}, {0.5063415607459867, 0.09511997668761289}, {0.29776355354222944, -0.0920188645098723}, {0.40088062025192517, -0.2108113931696775}, {0.31885574164104175, -0.4028321801944992}, {0.3868192507180663, -0.4500237657650667}, {0.365727062619254, -0.5313884146999712}, {0.22745617068083906, -0.5623070333217566} } )/* m_verts */,
        P( 30 )                                                 /* m_vertsCnt */,
    ...
    &PhxSprite_Ctor(                                            /* prize4 */
        P( { 0.47247194211060645, 0.23369367732558138, 0.08382816470263565, 0.1776320397870553 } )/* m_iniRect */,
        P( "prize4" )                                           /* m_name */,
        P( "crane_game_prize.png" )                             /* m_imgPath */,
        P( (cpVect[]){ {0.14308688309349385, -0.5102329444968342}, {-0.04205559741918127, -0.5232512808940586}, {-0.19907533886413867, -0.50209636811794}, {-0.28110048507107005, -0.5525425842400652}, {-0.4076536136639439, -0.5167420197909434}, {-0.43108914035502605, -0.4223590344588144}, {-0.3631253636819535, -0.38004939471558336}, {-0.42874553416670824, -0.21894722631254707}, {-0.3021921379777864, -0.07411802485829294}, {-0.4849912798981917, 0.11464813161497109}, {-0.46858630417601504, 0.17485823939176925}, {-0.37718700081186035, 0.18136694306786613}, {-0.27406939891006865, 0.11139368687241957}, {-0.2459463922463029, 0.3082962339155716}, {-0.17095206460432494, 0.4319705225937071}, {-0.07252167507916885, 0.4254608898725795}, {0.014190951100446188, 0.26273140619376445}, {0.15011796925449528, 0.41081523819957627}, {0.24151754021469793, 0.4026786618206821}, {0.2649530669057801, 0.28388631896988303}, {0.2743274916590513, 0.1048836825332797}, {0.4125986511935142, 0.15858452920696256}, {0.4969676711848114, 0.15207526810384725}, {0.5063415607459867, 0.09511997668761289}, {0.29776355354222944, -0.0920188645098723}, {0.40088062025192517, -0.2108113931696775}, {0.31885574164104175, -0.4028321801944992}, {0.3868192507180663, -0.4500237657650667}, {0.365727062619254, -0.5313884146999712}, {0.22745617068083906, -0.5623070333217566} } )/* m_verts */,
        P( 30 )                                                 /* m_vertsCnt */,
    ...
    &ImgSprite_Ctor(                                            /* arm_pivot_position */
        P( { 0.21785137099657773, 0.45171693313953487, 0.019801980198019802, 0.029069767441860465 } )/* m_iniRect */,
        P( "arm_pivot_position" )                               /* m_name */,
        P( "RedLight.png" )                                     /* m_imgPath */,
        P( { 0.0, 0.0 } )                                       /* m_center */,
        P( null )                                               /* m_constraints */,
        P( null )                                               /* m_mouseListeners */,
