 ...
 */
#define PhxSimpleMotor_Init(_m_source, _m_influence, _m_next)\
    PhxJoint_Init( P( _m_source ), P( _m_influence ), P( _m_next ) )\
    .vTbl = &gPhxSimpleMotorVtbl,\

#define PhxSimpleMotor_Ctor( _m_source, _m_influence, _m_next )    ( PhxSimpleMotor ){ \
    PhxSimpleMotor_Init( P( _m_source ), P( _m_influence ), P( _m_next ) ) \
}
