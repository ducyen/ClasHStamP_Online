 ...
 */
#define MouseListener_Init(_m_type, _m_action, _m_source, _m_event, _m_next)\
    EventListener_Init( P( _m_type ), P( _m_action ), P( _m_source ), P( _m_event ), P( _m_next ) )\
    .vTbl = &gMouseListenerVtbl,\

#define MouseListener_Ctor( _m_type, _m_action, _m_source, _m_event, _m_next )    ( MouseListener ){ \
    MouseListener_Init( P( _m_type ), P( _m_action ), P( _m_source ), P( _m_event ), P( _m_next ) ) \
}
