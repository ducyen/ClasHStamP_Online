...
typedef struct tagSharedStm {
    HdStateMachine base;
#define SharedStm_SharedTop_Dmy                 ( 1ULL <<  6 )
...
#define SharedStm_Shared2                       ( 1ULL <<  8 )
}SharedStm;
...
#define MainStm_S1                              ( 1ULL << 10 )
#define MainStm_S22                             ( 1ULL << 11 )
#define MainStm_S21                             ( 1ULL << 12 )
#define MainStm_S3                              ( 1ULL << 13 )
#define MainStm_S42                             ( 1ULL << 14 )
#define MainStm_S41                             ( 1ULL << 15 )
#define MainStm_Junction                        ( 1ULL << 16 )
#define MainStm_S6                              ( 1ULL << 17 )
#define MainStm_S812                            ( 1ULL << 18 )
#define MainStm_S813                            ( 1ULL << 19 )
#define MainStm_S811                            ( 1ULL << 20 )
#define MainStm_S72                             ( 1ULL << 21 )
#define MainStm_S711                            ( 1ULL << 22 )
#define MainStm_S712                            ( 1ULL << 23 )
#define MainStm_Initpseudostate0                ( 1ULL << ( MAX_STATE_NUM -  1 ) )
#define MainStm_S10                             ( 1ULL << 24 )
#define MainStm_S5                              ( 1ULL << 25 )
#define MainStm_S9                              ( 1ULL << 26 )
#define MainStm_S2_Dmy                          ( 1ULL << 27 )
#define MainStm_S2                              ( MainStm_S2_Dmy | MainStm_S22 | MainStm_S21 )
#define MainStm_S4_Dmy                          ( 1ULL << 28 )
#define MainStm_S4                              ( MainStm_S4_Dmy | MainStm_S42 | MainStm_S41 )
#define MainStm_S8_Dmy                          ( 1ULL << 29 )
#define MainStm_S8                              ( MainStm_S8_Dmy | MainStm_S812 | MainStm_S813 | MainStm_S811 )
#define MainStm_S71_Dmy                         ( 1ULL << 30 )
#define MainStm_S71                             ( MainStm_S71_Dmy | MainStm_S711 | MainStm_S712 )
#define MainStm_S7_Dmy                          ( 1ULL << 31 )
