...
#define SharedStm_Shared1                       ( 1ULL << 12 )
...
typedef struct tagMainStm {
    ...
    uint64_t nS4History;
    uint64_t nS7History;
#define MainStm_MainTop_0_Dmy                   ( 1ULL << 14 )
...
#define MainStm_MainStmInit                     ( 1ULL << 15 )
#define MainStm_S1                              ( 1ULL << 16 )
#define MainStm_S2Init                          ( 1ULL << 17 )
#define MainStm_S22                             ( 1ULL << 18 )
#define MainStm_S21                             ( 1ULL << 19 )
#define MainStm_S3                              ( 1ULL << 20 )
#define MainStm_S4Init                          ( 1ULL << 21 )
#define MainStm_S42                             ( 1ULL << 22 )
#define MainStm_S41                             ( 1ULL << 23 )
#define MainStm_Junction                        ( 1ULL << 24 )
#define MainStm_S6                              ( 1ULL << 25 )
#define MainStm_S812                            ( 1ULL << 26 )
#define MainStm_S813                            ( 1ULL << 27 )
#define MainStm_S811                            ( 1ULL << 28 )
#define MainStm_S8Init                          ( 1ULL << 29 )
#define MainStm_S72                             ( 1ULL << 30 )
#define MainStm_S711                            ( 1ULL << 31 )
#define MainStm_S712                            ( 1ULL << 32 )
#define MainStm_S71Init                         ( 1ULL << 33 )
#define MainStm_S7Init                          ( 1ULL << 34 )
#define MainStm_S10                             ( 1ULL << 35 )
#define MainStm_S5                              ( 1ULL << 36 )
#define MainStm_S9                              ( 1ULL << 37 )
#define MainStm_S2_Dmy                          ( 1ULL << 38 )
#define MainStm_S2                              ( MainStm_S2_Dmy | MainStm_S2Init | MainStm_S22 | MainStm_S21 )
#define MainStm_S4_Dmy                          ( 1ULL << 39 )
#define MainStm_S4                              ( MainStm_S4_Dmy | MainStm_S4Init | MainStm_S42 | MainStm_S41 )
#define MainStm_S8_Dmy                          ( 1ULL << 40 )
#define MainStm_S8                              ( MainStm_S8_Dmy | MainStm_S812 | MainStm_S813 | MainStm_S811 | MainStm_S8Init )
#define MainStm_S71_Dmy                         ( 1ULL << 41 )
#define MainStm_S71                             ( MainStm_S71_Dmy | MainStm_S711 | MainStm_S712 | MainStm_S71Init )
#define MainStm_S7_Dmy                          ( 1ULL << 42 )
