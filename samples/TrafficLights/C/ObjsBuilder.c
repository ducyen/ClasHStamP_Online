...
Sprite* g_objects[] = {
    &RedLight_Ctor(                                             /* westRedLight */
        ...
        P( &AttachmentConstraint_Ctor( &eastRedLight, 1, 
           &TranslationConstraint_Ctor( &eastRedLight, 1, 
           &RotationConstraint_Ctor( &eastRedLight, 1, 
           null ) ) ) )/* m_constraints */
    ),
    &RedLight_Ctor(                                             /* eastRedLight */
        P( { 0.6385681293302541, 0.5204598067574969, 0.06062355658198614, 0.07268892540356313 } )/* m_iniRect */,
        P( "RedLight.png" )                                     /* m_imgPath */,
        P( &AttachmentConstraint_Ctor( &eastGreenLight, 1, 
           &TranslationConstraint_Ctor( &eastGreenLight, 1, 
           &RotationConstraint_Ctor( &eastGreenLight, 0, 
           null ) ) ) )/* m_constraints */
    ),
